...
public class ResidentModel {
    ...
    Resident translateModelToResident() {
        Resident resident = new Resident();
        resident.setFirstName(this.firstName);
        resident.setLastName(this.lastName);
        resident.setPesel(this.pesel);
        resident.setGender(this.gender);
        resident.setDateDOB(this.dateDOB);
        ...
        resident.setIsBlocked(this.isBlocked);
        resident.setPaymentFee(this.paymentFee);
        resident.setResidentType(this.residentType);
        resident.setRoom(this.room);
        resident.setPayments(this.payments);
        resident.setResidentTypeFields(this.residentTypeFields);
        resident.setResidentTypeValuesFields(this.residentTypeValuesFields);
